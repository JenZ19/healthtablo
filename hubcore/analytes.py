...
ANALYTES: list[Analyte] = [
    ...
    Analyte("erythrocytes", "Эритроциты", "RBC", "10^12/л", "гематология",
            ["rbc", "эритроциты", "эритр", "красные кровяные тельца"]),
    ...
    Analyte("hba1c", "Гликированный гемоглобин", "HbA1c", "%", "углеводный обмен",
            ["hba1c", "гликированный гемоглобин", "гликозилированный гемоглобин", "hba1с"]),
    ...
    Analyte("crp", "С-реактивный белок", "CRP", "мг/л", "воспаление",
            ["crp", "срб", "с-реактивный белок", "срб (высокочувствительный)", "hs-crp"]),
